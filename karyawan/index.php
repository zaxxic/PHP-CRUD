...
include "koneksi.php";
$query = mysqli_query($koneksi, "SELECT * from karyawan WHERE 1");
$id = 1;
    ...
    ?>
                <tr class="table-primary">
                    ...
                    <td>
                        ...
                        <a class="edit" href='edit.php?id= <?= $karyawan['id'] ?>'><b style="text-decoration : none;">Edit</b></a>
                    </td>
                    <td>
                        <a class="hapus" href='server.php?id= <?= $karyawan['id'] ?>'><b style="text-decoration : none;">Hapus</b></a>
